...
<head>
  ...
  <title>Aplikasi Kasir Laundry</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">V2 Laundry</a>
        </div>
      </div>
...
@yield('content')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023<a href="">V2 Laundry</a>.</strong> All rights reserved.
  </footer>
